...
class Test(unittest.TestCase):
    ...
    def test_cte_basic_parse(self):
        ...
        self.assertEqual(source_str, source.source())
        self.assertNotEqual(source_str, parsed_source.parsed_source())
    ...
    def test_cte_parse_matches(self):
        ...
        """
        source_2 = Source(source_str_2)
        self.assertIsNotNone(source_2)
        parsed_source_2 = ParsedSource(source_2)
        self.assertIsNotNone(parsed_source_2)
        self.assertEqual(source_str_2, source_2.source())
        self.assertNotEqual(source_str_2, parsed_source_2.parsed_source())
    ...
    def test_cte_complex_encode(self):
        encoded_source = EncodedSource(ParsedSource(Source(complex_query)))
        self.assertIsNotNone(encoded_source)
        #self.assertEqual(complex_query, encoded_source.parsed_source().source())
    ...
    def test_cte_encode_matches(self):
        ...
        FROM cte    JOIN cte2 USING (planet)
        """
        encoded_source_2 = EncodedSource(ParsedSource(Source(source_str_2)))
        self.assertIsNotNone(encoded_source_2)
        self.assertEqual(encoded_source.encoded_source(), encoded_source_2.encoded_source())
